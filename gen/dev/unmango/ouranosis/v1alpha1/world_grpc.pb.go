...
const (
	WorldService_Join_FullMethodName = "/dev.unmango.ouranosis.v1alpha1.WorldService/Join"
)
...
func (c *worldServiceClient) Join(ctx context.Context, in *JoinRequest, opts ...grpc.CallOption) (*JoinResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(JoinResponse)
	err := c.cc.Invoke(ctx, WorldService_Join_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedWorldServiceServer) Join(context.Context, *JoinRequest) (*JoinResponse, error) {
...
func _WorldService_Join_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(JoinRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorldServiceServer).Join(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WorldService_Join_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorldServiceServer).Join(ctx, req.(*JoinRequest))
	}
...
var WorldService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dev.unmango.ouranosis.v1alpha1.WorldService",
	HandlerType: (*WorldServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Join",
			Handler:    _WorldService_Join_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "dev/unmango/ouranosis/v1alpha1/world.proto",
}
